const libraryItems = [
  { name: "Colossians", description: "The supremacy of Christ and life in Him", href: "/", category: "book", current: true },
...
export function GlobalShell() {
  return (
    <header className="mbe-global-shell" data-tool="colossians" data-embedded="true">
...
export function GlobalFooter() {
  return (
    <footer className="mbe-global-footer" data-tool="colossians">
